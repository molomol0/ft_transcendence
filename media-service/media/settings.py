...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MEDIA_DB_NAME'),
        'USER': os.getenv('MEDIA_DB_USER'),
        'PASSWORD': os.getenv('MEDIA_DB_PASSWORD'),
        'HOST': os.getenv('MEDIA_DB_HOST'),
        'PORT': os.getenv('MEDIA_DB_PORT'),
    }
}
...
AUTH_USER_MODEL = 'media.CustomUser'